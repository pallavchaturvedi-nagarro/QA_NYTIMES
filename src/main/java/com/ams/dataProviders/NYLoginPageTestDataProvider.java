...
public class NYLoginPageTestDataProvider {
    private static final String FILE_PATH= DataConfigHolder.getInstance().csvFilePath();
    private static final String USER_DIRECTORY= System.getProperty("user.dir");

    private static final String FILE_NAME="NYLoginPageTestData.csv";

    private static final String DATA_FILE=USER_DIRECTORY+FILE_PATH+FILE_NAME;

    private NYLoginPageTestDataProvider(){}

    @DataProvider(name="NYLoginPageData")
